...
export default function AtendenteForm({
  onSave,
  onCancel,
}: AtendenteFormProps) {
  ...
  const formatTelefone = (value: string) => {
    const numeros = value.replace(/\D/g, ""); // remove tudo que não é número
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <input
            ...
            className="w-full cursor-pointer text-white hover:bg-cyan-600 rounded px-2 py-1 bg-cyan-900"
